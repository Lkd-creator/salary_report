...
| 5 | **ЗНР Количество** | Общее количество созданных сделок (для аудита конверсии ЗНР) |
| 5 | **АКБ активность** | АКБ менеджеров (для аудита активности клиента и работы с закрепленной базой) |
